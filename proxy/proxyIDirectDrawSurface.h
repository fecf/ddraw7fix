...
interface proxyIDirectDrawSurface : public IDirectDrawSurface
{
public:
  proxyIDirectDrawSurface(IDirectDrawSurface** ppOrigInterface);
  virtual ~proxyIDirectDrawSurface();

  virtual HRESULT __stdcall AddAttachedSurface(LPDIRECTDRAWSURFACE ARG0);
  virtual HRESULT __stdcall AddOverlayDirtyRect(LPRECT ARG0);
  virtual HRESULT __stdcall Blt(LPRECT ARG0, LPDIRECTDRAWSURFACE ARG1, LPRECT ARG2, DWORD ARG3, LPDDBLTFX ARG4);
  virtual HRESULT __stdcall BltBatch(LPDDBLTBATCH ARG0, DWORD ARG1, DWORD ARG2);
  virtual HRESULT __stdcall BltFast(DWORD ARG0, DWORD ARG1, LPDIRECTDRAWSURFACE ARG2, LPRECT ARG3, DWORD ARG4);
  virtual HRESULT __stdcall DeleteAttachedSurface(DWORD ARG0, LPDIRECTDRAWSURFACE ARG1);
  ...
  virtual HRESULT __stdcall Flip(LPDIRECTDRAWSURFACE ARG0, DWORD ARG1);
  virtual HRESULT __stdcall GetAttachedSurface(LPDDSCAPS ARG0, LPDIRECTDRAWSURFACE * ARG1);
  ...
  virtual HRESULT __stdcall UpdateOverlay(LPRECT ARG0, LPDIRECTDRAWSURFACE ARG1, LPRECT ARG2, DWORD ARG3, LPDDOVERLAYFX ARG4);
  virtual HRESULT __stdcall UpdateOverlayDisplay(DWORD ARG0);
  virtual HRESULT __stdcall UpdateOverlayZOrder(DWORD ARG0, LPDIRECTDRAWSURFACE ARG1);

private:
  IDirectDrawSurface* self_;
};